...
import com.perusudroid.broadcastpro.MainActivity;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.getAction().equals(Constants.alarm.ACTION)){  //my custom intent
			...
			Notification notif = new NotificationCompat.Builder(context, Constants.alarm.id)
			...
			.setChannelId(Constants.alarm.id)
